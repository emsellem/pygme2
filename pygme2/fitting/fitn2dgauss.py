...
from pygme2.BaseMGE import BaseMultiGaussian2D
...
#        newChi2 = fitn2dgauss_chi2_err(np.delete(Ibestpar_array, i, 0), paramsPSF, r, theta, data, nerr)
    ...
    resultMultiGaussian2D = BaseMultiGaussian2D(Ibestfit_params[:,0],Ibestfit_params[:,1],Ibestfit_params[:,2],Ibestfit_params[:,3])
    
    return resultMultiGaussian2D, newresult, n_centred_twodgaussian_Imax(pars=Ibestfit_params, parPSF=paramsPSF)(r, theta).reshape(datashape)
